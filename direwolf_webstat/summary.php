...
<html>
   ...
   <body>
      ...
      <?php
         ...
         ?>
      <center>
         <font size="20"><b></b></font> <font color="red" size="20"><b><?php echo "$MYCALL";?></b></font>


 

         <br>
         <br><b>Indicativo: <a href="frames.php">Pesquisar</a><br><br>
      ...
      <br><br>
		 ...
		 echo "<b>Quantidade de quadros no log: </b>".$linesinlog;
